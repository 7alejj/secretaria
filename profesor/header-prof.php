...
<head>
<meta charset="utf-8">
    <link rel="stylesheet" href="../css/estindex.css"><link rel="stylesheet" href="../css/estilo-prof.css">
...
<nav  id="nav">
    <ul class="u-1"> 
        <li></li>
    <li class="li"  id="a-pr1"><a  class="a-s6" href="formulario.php">Material</a></li>  
        
        
    <li class="li"  id="a-pr2"><a  class="a-s6" href="list-cursos.php"> Mis Cursos</a>
