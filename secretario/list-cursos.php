...
<div class="table-wrapper">
        	...
        	<section>
		<h1>Alumnos sin curso</h1>		
		<div>
			<label for="criterio" >Buscar</label>
			<input type="text" name="criterio" id="caja_criterio">	
		</div>
	...
	<script type="text/javascript" src="../jsn/jquery.min.js"></script>
	<script type="text/javascript" src="../jsn/main.js"></script>
